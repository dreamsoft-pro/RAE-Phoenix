...
from feniks.types import SystemModel, MetaReflection, ReflectionLevel
from feniks.core.reflection_rules import ReflectionRuleSet
...
class MetaReflectionEngine:
    ...
    The engine applies a set of rules to generate reflections at different levels:
    - Level 0 (OBSERVATION): Pure data observations
    - Level 1 (REFLECTION): Insights and conclusions
    - Level 2 (META_REFLECTION): Reflections about architecture quality
    """
    ...
    def load_reflections_jsonl(self, input_path: Path) -> List[MetaReflection]:
        ...
        """
        from feniks.types import ReflectionEvidence, ReflectionLevel, ReflectionScope, ReflectionImpact
